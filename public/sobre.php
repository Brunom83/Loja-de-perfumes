...
<body>
  ...
  <header class="bg-dark text-white py-4 text-center">
    <h1>Sobre Nós</h1>
    <p class="mb-0">Conhece a equipa por trás da nossa loja de perfumes</p>
  </header>
  ...
  <main class="container py-5">
    ...
    <section>
      ...
      <p>Ser a principal referência online em perfumes de alta qualidade em Portugal e além, promovendo o requinte e a individualidade em cada detalhe.</p>
    ...
    <section>
      ...
      <div class="row g-4">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="/assets/images/ronnie_manuel.jpg" class="team-photo" alt="Manuel Liendo">
            <div class="card-body">

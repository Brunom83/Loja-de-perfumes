...
<header class="bg-dark py-2 border-bottom">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <nav class="d-flex align-items-center gap-3 position-relative">
            ...
            <a href="/perfumes_verde/admin/stock/index.php" class="text-light text-decoration-none">Stock</a>
            <a href="/perfumes_verde/index.php" class="text-light text-decoration-none">Ver Loja</a>
            <a href="<?= $adminBase ?>/../public/logout.php" class="text-light text-decoration-none">Logout</a>
                    ...
                    data.forEach(n => {
                        ...
                        li.innerHTML = `
                            <div class="flex-grow-1 pe-2">
                                ...
                                <small>${n.mensagem.substring(0, 60)}...</small>
                            </div>

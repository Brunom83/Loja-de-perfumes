...
<div class="container mt-5">
  ...
  <div class="carousel-inner rounded shadow">
    <div class="carousel-item active">
      <img src="/assets/images/banner_dior.jpg" class="d-block w-100 banner-img" alt="Slider 1">
    </div>
    <div class="carousel-item">
      <img src="/assets/images/banner_acqua.jpg" class="d-block w-100 banner-img" alt="Slider 2">
    </div>
  </div>
            ...
            <?php foreach ($promocao as $p): ?>
                <div class="col">
                    <div class="card h-100 text-center shadow-sm">
                        <img src="/assets/images/<?= htmlspecialchars($p['imagem']) ?>" class="card-img-top img-fluid" alt="<?= $p['nome'] ?>">
                        <div class="card-body">
                            ...
                            <a href="/public/produto.php?id=<?= $p['id'] ?>" class="btn btn-outline-success">Ver Produto</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
                ...
                <div class="col">
                    <div class="card h-100 text-center shadow-sm">
                        ...
                        <?php endif; ?>
                            ...
                            <a href="/public/produto.php?id=<?= $p['id'] ?>" class="btn btn-outline-primary">Ver Produto</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
                ...
                <div class="col">
                    <div class="card h-100 text-center shadow-sm">
                        ...
                        <?php endif; ?>
                            ...
                            <a href="/public/produto.php?id=<?= $p['id'] ?>" class="btn btn-outline-dark">Ver Produto</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
